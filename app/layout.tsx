...
export function Breadcrumbs({
    ...
    return (
        <>
            ...
            <div className="fixed inset-x-0 bottom-12 top-0 hidden max-h-[calc(100vh-3rem)] flex-1 overflow-y-auto
							border-t bg-white peer-open:block lg:relative lg:inset-x-auto lg:bottom-auto lg:flex
							lg:max-h-none">
                {children}
            </div>
        </>
